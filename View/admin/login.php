...
<head>
   ...
   <!-- CSS -->
   <link rel="stylesheet" href="public/bootsnip.css">
			...
			<div class="card-body">
				<form action="index.php?controller=admin&action=login" method="POST">
					<div class="input-group form-group">
						...
						<input name="Ten_dang_nhap" type="text" class="form-control" placeholder="Tên đăng nhập">
					...
					<div class="form-group">
						<input style="width: 150px" type="submit" value="Đăng nhập" class="btn float-right login_btn">
					</div>
				</form>
			</div>
